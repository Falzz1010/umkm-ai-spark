...
export default function Dashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-100 dark:bg-background px-4 py-8 animate-fade-in flex items-center justify-center page-transition">
  ...
  return (
    <NotificationsProvider>
      <div className="min-h-screen bg-gray-100 dark:bg-background px-2 sm:px-6 py-6 page-transition animate-fade-in">
