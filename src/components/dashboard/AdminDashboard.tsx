...
export function AdminDashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-100 dark:bg-background p-2 sm:p-4 lg:p-8 animate-fade-in flex items-center justify-center page-transition">
  ...
  return (
    <RoleGuard allowedRoles={['admin']}>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:bg-gradient-to-br dark:from-background dark:via-background dark:to-muted/20 p-2 sm:p-4 lg:p-6 xl:p-8 max-w-7xl mx-auto animate-fade-in page-transition">
        ...
        <div className="animate-slide-up" style={{'--index': 2} as any}>
          <div className="bg-white/80 dark:bg-card/80 backdrop-blur-sm rounded-xl lg:rounded-2xl shadow-lg border border-gray-200 dark:border-border/50 p-3 sm:p-4 lg:p-6 transition-all duration-300 hover:shadow-xl">
            <Tabs defaultValue="analytics" className="space-y-3 sm:space-y-4 lg:space-y-6">
              {/* Enhanced Responsive Tab List */}
              <TabsList className="w-full h-auto grid grid-cols-2 md:grid-cols-4 gap-1 sm:gap-2 bg-gradient-to-r from-gray-100/40 via-gray-200/60 to-gray-100/40 dark:bg-gradient-to-r dark:from-muted/40 dark:via-muted/60 dark:to-muted/40 p-1.5 sm:p-2 lg:p-3 rounded-xl shadow-inner backdrop-blur-sm border border-gray-200 dark:border-border/30">
                <TabsTrigger 
                  value="analytics" 
                  className="flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-medium px-2 sm:px-3 lg:px-4 py-2.5 sm:py-3 lg:py-3.5 rounded-lg lg:rounded-xl data-[state=active]:bg-gradient-to-r data-[state=active]:from-background data-[state=active]:to-background/95 data-[state=active]:shadow-lg data-[state=active]:shadow-primary/10 data-[state=active]:text-primary data-[state=active]:font-semibold data-[state=active]:border data-[state=active]:border-primary/20 transition-all duration-300 ease-out hover:bg-background/60 hover:shadow-md hover:scale-[1.02] active:scale-[0.98] min-h-[44px] sm:min-h-[48px]"
                >
              ...
              <TabsContent value="analytics" className="animate-fade-in">
                <Card className="bg-gradient-to-br from-white/90 to-gray-50/60 dark:bg-gradient-to-br dark:from-card/90 dark:to-card/60 backdrop-blur-sm border-gray-200 dark:border-border/50 shadow-xl rounded-xl lg:rounded-2xl transition-all duration-300 hover:shadow-2xl">
