...
export function AdminDashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-200/60 dark:bg-background p-3 sm:p-4 lg:p-6 xl:p-8 max-w-full animate-fade-in flex items-center justify-center page-transition">
  ...
  return (
    <RoleGuard allowedRoles={['admin']}>
      <div className="min-h-screen bg-gradient-to-br from-gray-100/80 via-gray-150/60 to-gray-200/40 dark:bg-gradient-to-br dark:from-background dark:via-background dark:to-muted/20 p-3 sm:p-4 lg:p-6 xl:p-8 max-w-full animate-fade-in page-transition">
